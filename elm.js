...
Elm.Input.make = function (_elm) {
   ...
   var nearWindowEdgeSide = F2(function (dim,
   pos) {
      return function () {
         var diff = dim - pos;
         var spacing = 20;
   ...
   var nearWindowEdge = F2(function (_v0,
   _v1) {
      return function () {
         switch (_v1.ctor)
         {case "_Tuple2":
            return function () {
                 ...
                 {case "_Tuple2":
                    return {ctor: "_Tuple2"
                           ,_0: A2(nearWindowEdgeSide,
                           $Basics.toFloat(_v0._0),
                           $Basics.toFloat(_v1._0))
                           ,_1: A2(nearWindowEdgeSide,
   ...
   _elm.Input.values = {_op: _op
                       ...
                       ,delta: delta
                       ,scroll: scroll
                       ,nearWindowEdge: nearWindowEdge
                       ,nearWindowEdgeSide: nearWindowEdgeSide
                       ,userInput: userInput
                       ,input: input};
   return _elm.Input.values;
};
